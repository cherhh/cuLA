...
def launch_k2(
    ...
    out_flat = out.view(T_total, H, D)
    compact_args = (
        v_flat, beta, ws_qd, ws_kd, ws_kr, ws_gt, ws_inv, ws_mqk,
        out_flat, cu_seqlens_tiles, initial_state_fp32, final_state_fp32,
        stream,
    )
    full_args = (
        v_flat, beta, ws_qd, ws_kd, ws_kr, ws_gt, ws_inv, ws_mqk,
        out_flat, cu_seqlens_tiles, initial_state_fp32, final_state_fp32,
        H, total_tiles, T_total, N_seqs,
        has_initial_state_flag, has_final_state_flag, state_transposed,
        stream,
    )
